...
Tiny javascript MVC-framework for working with RESTful JSON interface. (Inspired by [Backbone.js](https://github.com/jashkenas/backbone)). Developed in the learning purposes
